...
public class OrderSubmitController {
    ...
    @PostMapping("/submit")
    public ResponseData<OrderResVO> submit(@Valid @RequestBody AdminOrderReqVO adminOrderReqVO, BindingResult bindingResult, HttpServletRequest request) throws Exception {
