...
public class CarOrderImageController {
    ...
    @AutoDocMethod(description = "订单照片列表;Type:1为取车照片，2为还车照片，3为违章缴纳凭证，4为车主上传，5为平台上传", value = "订单照片列表", response = CarOrderImageDetailRespVO.class)
    ...
    @AutoDocMethod(description = "添加订单照片", value = "添加订单照片", response = ResponseData.class)
    ...
    @AutoDocMethod(description = "修改订单照片；Type:1为取车照片，2为还车照片，3为违章缴纳凭证，4为车主上传，5为平台上传", value = "修改订单照片", response = ResponseData.class)
    ...
    @AutoDocMethod(description = "修改订单照片", value = "订单照片", response = ResponseData.class)
