...
public class BaseFilter implements SubmitOrderFilter{
    ...
    @Override
	public void doFilter(SubmitReq submitReqDto, OrderContextDto orderContextDto, FilterChain chain, int index) throws SubmitOrderException {
	...
	@Override
	public boolean validator(SubmitReq submitReqDto, OrderContextDto orderContextDto) throws SubmitOrderException {
