//package com.atzuche.order.delivery.common.delivery;
//
...
//import com.atzuche.order.delivery.common.delivery.dto.GetReturnOverTransportDTO;
...
//                        log.error("取车超运能获取失败");
//                        throw new DeliveryOrderException(DeliveryErrorCode.DELIVERY_PARAMS_ERROR.getValue(), "取车超运能获取失败");
//                    }
//                    t.setStatus(Transaction.SUCCESS);
//                } catch (DeliveryOrderException oe) {
//                    Cat.logError("Feign 取车超运能获取失败", oe);
//                    t.setStatus(oe);
//                    throw oe;
//                } catch (Exception e) {
//                    DeliveryOrderException getCarOverCostErrorException = new DeliveryOrderException(DeliveryErrorCode.DELIVERY_PARAMS_ERROR);
...
//                    throw oe;
//                } catch (Exception e) {
//                    DeliveryOrderException returnCarOverCostErrorException = new DeliveryOrderException(DeliveryErrorCode.DELIVERY_PARAMS_ERROR);
