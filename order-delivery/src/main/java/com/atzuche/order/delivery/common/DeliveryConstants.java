...
public class DeliveryConstants {
    ...
    public static final String CANCEL_FLOW_ORDER = "http://114.55.61.47:8888/HRM3_WEB_AOTU/" + "AotuInterface/cancelfloworder";

    public static final String CHANGE_FLOW_ORDER = "http://114.55.61.47:8888/HRM3_WEB_AOTU/" + "AotuInterface/floworderchange";

    public static final String ADD_FLOW_ORDER = "http://114.55.61.47:8888/HRM3_WEB_AOTU/" + "AotuInterface/addflowprocessdata";
