...
public class OrderSubsidyDetailUtils {
     ...
     * @return
     */
    public static int getOrderConsoleCostDetail(List<OrderConsoleCostDetailEntity> all, SubsidySourceCodeEnum subsidySourceCodeEnum, SubsidySourceCodeEnum subsidyTargetCodeEnum){
        int total =0;
