...
public enum RenterCashCodeEnum {
    ...
    SETTLE_ZUCHEFEE_TO_SUPPLEMENT_AMT("11130038","租车费用抵扣补付金额"),
    ...
    ACCOUNT_CONSOLE_RENTER_SUBSIDY_COST_BACK("21130048","平台给租客的补贴退回虚账户"),
...
//    ACCOUNT_RENTER_DELIVERY_MILEAGE_COST_PROXY("21130029","交接车-获取代管车超里程费用"),
  ...
  //第四区域块 看第4位，从4开始。  后4位从0001开始    后面是以此类推，确保费用编码不能重复。
    ...
    ACCURATE_GET_SRV_AMT("11110020","精准取车服务费"),
    ACCURATE_RETURN_SRV_AMT("11110021","精准还车服务费"),

    ADD_INCOME_OWNER_INCOME_TO_HISTORY_AMT("21130041","追加收益转历史欠款"),
    ADD_INCOME_OWNER_INCOME_TO_OLD_HISTORY_AMT("21130042","追加收益转老历史欠款"),
    ADD_INCOME_PRODUCE_DEBUT("21130043","追加欠款"),
    ADD_INCOME_PRODUCE_INCOME("21130044","追加收益"),
    ADD_INCOME_PRODUCE_INCOME_SECONDARY("21130045","追回收益（二清）"),
    ADD_INCOME_PRODUCE_INCOME_OLD("21130046","追回收益（老订单）"),
    ADD_INCOME_PRODUCE_INCOME_NEW("21130047","追回收益（新订单）"),
    ;
