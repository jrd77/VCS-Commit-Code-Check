...
public enum ConsoleCashCodeEnum {
    ...
    CAR_DEPOSIT_DETAIN_WZ_FINE("31020010", "违章违约费"),
    CAR_DEPOSIT_DETAIN_WZ_STOPCHARGE("31020011", "违章停运费"),
    CAR_DEPOSIT_DETAIN_CLAIM_REPAIRCHARGE("31020012", "理赔维修费"),
    CAR_DEPOSIT_DETAIN_CLAIM_STOPCHARGE("31020013", "理赔停运费"),
    CAR_DEPOSIT_DETAIN_RISK_REPAIRCHARGE("31020014", "风控维修费"),
    CAR_DEPOSIT_DETAIN_RISK_STOPCHARGE("31020015", "风控停运费"),
    CAR_DEPOSIT_DETAIN_RISK_COLLECTCHARGE("31020016", "风控收车费"),
    ...
    /**
     * convert int value to ConsoleCashCodeEnum
     *
     * @param cashNo int value
     * @return ConsoleCashCodeEnum
     */
    public static ConsoleCashCodeEnum from(String cashNo) {
        for (ConsoleCashCodeEnum c : values()) {
            if (StringUtils.equals(cashNo, c.cashNo)) {
                return c;
            }
        }
