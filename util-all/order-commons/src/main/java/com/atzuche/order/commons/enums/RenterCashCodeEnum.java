...
public enum RenterCashCodeEnum {
    ...
    ACCOUNT_WALLET_COST("11111001","个人钱包"),
    CASHIER_RENTER_COST("11111001","租车费用"),
    SETTLE_DEPOSIT_TO_RENT_COST("11111002","车俩押金转租车费用"),
    SETTLE_RENT_COST_TO_HISTORY_AMT("11111003","租车费用转历史欠款"),
    SETTLE_DEPOSIT_TO_HISTORY_AMT("11111004","车俩押金转历史欠款"),
    SETTLE_RENT_COST_TO_RETURN_AMT("11111005","结算租车费用退还"),
    SETTLE_RENT_DEPOSIT_TO_RETURN_AMT("11111006","结算租车押金退还"),
    SETTLE_OWNER_INCOME_TO_HISTORY_AMT("21111001","车主收益转历史欠款"),
    HISTORY_AMT("11111007","历史欠款"),
    SETTLE_RENT_COST_TO_FINE("11111008","租车费用转罚金"),
    SETTLE_RENT_WALLET_COST_TO_FINE("11111009","租车费用钱包转罚金"),
    SETTLE_RENT_DEPOSIT_COST_TO_FINE("11111010","车辆押金转罚金"),
    SETTLE_RENT_WZ_DEPOSIT_COST_TO_FINE("11111011","违章押金转罚金"),
    CANCEL_RENT_DEPOSIT_TO_RETURN_AMT("11111012","取消租车押金退还"),
    CANCEL_RENT_WZ_DEPOSIT_TO_RETURN_AMT("11111013","取消违章押金退还"),
    CANCEL_WZ_DEPOSIT_TO_HISTORY_AMT("11111014","违章押金转历史欠款"),
    CANCEL_RENT_COST_TO_RETURN_AMT("11111015","取消租车费用退还"),
    ACCOUNT_RENTER_DETAIN_CAR_AMT("11111016","暂扣的租车费用"),
