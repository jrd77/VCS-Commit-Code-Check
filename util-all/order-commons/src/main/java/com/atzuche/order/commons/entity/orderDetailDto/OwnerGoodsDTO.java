 ...
 * 
 * @author ZhangBin
 * @date 2020-01-14 16:43:19
 * @Description:
 */
@Data
public class OwnerGoodsDTO implements Serializable {
	private static final long serialVersionUID = 1L;
         ...
         */
        @AutoDocProperty(value="平台服务费比例/代官车服务费比例（仅车主端有）",required=true)
        private Double serviceRate;
    	/**
         * 是否超证:0否 1是
         */
        @AutoDocProperty(value="是否超证:0否 1是",required=true)
        private Integer moreLicenseFlag;
    	/**
         * 行驶证到期日期
         */
        @AutoDocProperty(value="行驶证到期日期",required=true)
